...
def test_create_camera():
    response = client.post("/api/cameras", json={"name": "camera1", "ip_addr": "192.168.1.1", "mac": "00:11:22:33:44:55", "frame_height": 1080, "frame_width": 1920})
...
def test_create_camera_failure():
    response = client.post("/api/cameras", json={"name": "camera1"})
...
def test_get_camera_failure():
    response = client.get("/api/cameras/11111")
